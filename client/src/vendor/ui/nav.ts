...
export const NAV: NavGroup[] = [
  {
    ...
    items: [
      ...
      { key: "project-context", label: "Project Context", icon: "FileText", href: "/repos/:repoId/project-context", gKey: "c" },
    ],
  },
  {
    section: "SKILLS LAB",
    items: [
      ...
      { key: "eval", label: "Eval Dashboard", icon: "FlaskConical", href: "/evals", gKey: "e" },
    ],
  },
];
