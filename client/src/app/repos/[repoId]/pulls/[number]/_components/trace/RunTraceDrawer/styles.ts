...
export const s = {
  ...
  // ---- FindingsSection ----
  findingsContainer: { display: "flex", flexDirection: "column", gap: 10 } satisfies CSSProperties,
  findingCard: {
    border: "1px solid var(--border)",
    borderRadius: 8,
    padding: "10px 12px",
  ...
  findingCardHeader: { display: "flex", alignItems: "center", gap: 8, marginBottom: 4 } satisfies CSSProperties,
  findingCardFile: { fontSize: 11.5, color: "var(--text-muted)", marginBottom: 6 } satisfies CSSProperties,
  findingCardText: { fontSize: 12.5, color: "var(--text-secondary)", lineHeight: 1.5 } satisfies CSSProperties,
